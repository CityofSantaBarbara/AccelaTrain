...
if (AInfo["Desired Scoping and Conditioning Questions 1"] == "CHECKED") {
  ...
  totPoints = totPoints + "The current location of this gas service is the same location that was previously approved by the Ci ";
}
if (AInfo["Desired Scoping and Conditioning Questions 2"] == "CHECKED") {
  if (totPoints != "") totPoints += "& ";
  totPoints = totPoints + "The new gas service will be installed in accordance with the manufacturer’s installation ";
}
