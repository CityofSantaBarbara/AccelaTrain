/*------------------------------------------------------------------------------------------------------/
| Program : ACA_EVENT_LOCATION_BEFORE_PAGEFLOW.js 
...
try {
    ...
    if (
      ...
      cancel = true;
      showMessage = true;
      comment("See error message below in each section in red text");
    } else {
      cancel = false;
      showMessage = false;
      comment("");
    ...
    showDebug = true;
    logDebug("An error has occurred in ACA_EVENT_LOCATION_BEFORE_PAGEFLOW: Main function: " + err.message);
    logDebug(err.stack);
}
